...
import '../../../treinos/shared/widgets/rotina_input_decoration.dart';

class PersonalAtivarTemplatePage extends StatefulWidget {
  final String templateId;
  final String alunoId;
  final String alunoNome;

  const PersonalAtivarTemplatePage({
    super.key,
  ...
  @override
  State<PersonalAtivarTemplatePage> createState() =>
      _PersonalAtivarTemplatePageState();
}
