...
class PersonalFinanceiroAlunoPage extends StatefulWidget {
  ...
  const PersonalFinanceiroAlunoPage({
    super.key,
  ...
  @override
  State<PersonalFinanceiroAlunoPage> createState() =>
      _PersonalFinanceiroAlunoPageState();
}

class _PersonalFinanceiroAlunoPageState
    extends State<PersonalFinanceiroAlunoPage> {
    ...
    return TextButton.icon(
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PersonalHistoricoFinanceiroPage(
